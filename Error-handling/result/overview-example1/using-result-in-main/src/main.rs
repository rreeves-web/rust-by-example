...
// debug representation of the error (using the `Debug`[url]
// https://doc.rust-lang.org/std/fmt/trait.Debug.html[/url] trait). The following
// example shows such a scenario and touches on aspects covered in the following
// section.
