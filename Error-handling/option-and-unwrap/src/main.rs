...
// expect *some* drink but don't receive one? That case would be just as bad, so
...
// with expect[url]https://doc.rust-lang.org/std/option/enum.Option.html#method.expect[/url]
