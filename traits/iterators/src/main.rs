// The Iterator[url]https://doc.rust-lang.org/core/iter/trait.Iterator.html[/url]
...
impl Iterator for Fibonacci {
    ...
    // We use Self::Item in the return type, so we can change the type without
    // having to update the function signatures.
