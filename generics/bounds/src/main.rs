...
// methods[url]https://doc.rust-lang.org/stable/rust-by-example/fn/methods.html[/url]
// of traits specified in the bounds. For example:
...
// `T` must implement `HasArea`. Any type which meets the bound can access
