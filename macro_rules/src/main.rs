// Rust provides a powerful macro system that allows metaprogramming. As
// you've seen in previous chapters, macros look like functions, except that their
// name ends with a bang, but instead of generating a function call, macros are
...
//      writing a macro is a useful wya to avoid repeating code.
...
//      variable number of arguments. An example is `println!` which could take
//      any number of arguments, depending on the format string!.
