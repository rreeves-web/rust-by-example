...
fn main() {
    ...
    // TODO ^ uncomment this line to view the error

    // The `len` method yields the number of elements currently stored in a vector
    println!("Vector length:{}", xs.len());

    // Indexing is done using the square brackets (zero-indexed)
    ...
    // TODO ^ uncomment to view the error
...
// More `Vec` methods can be found under the `std::vec` module at this link:
