...
// just one implementation. (see also: `BTreeSet`)
// Link to BTreeSet: https://doc.rust-lang.org/std/collections/struct.BTreeSet.html)
...
fn main() {
    ...
    // It usually prints its elements in the format `[elem1, elim2, ...]`
    println!("A: {:?}", a);
    println!("B: {:?}", b);
